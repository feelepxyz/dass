...
//
//   node render/render.mjs --manifest build/renders/manifest.json --out build/renders
//
// Normally invoked through render_photo.py, which builds the GLBs and texture
// maps this needs.
...
async function main() {
  ...
  await page.goto(`${origin}/render/scene.html`, { waitUntil: 'load' });
